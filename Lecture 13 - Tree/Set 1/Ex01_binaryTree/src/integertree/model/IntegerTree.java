...
public class IntegerTree {
	...
	private int nodeFloor(Node rootSubTree, int value) throws Exception {
		if (root == null) {
			throw new Exception("Empty tree");
	...
	private Node removeChild(Node rootSubTree, int value) throws Exception {
		if (root == null) {
			throw new Exception("Empty tree");
